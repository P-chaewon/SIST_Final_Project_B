					...
					<article class="edit-object">
						...
						<div class="delete-space">
							...
							<form class="delete-form" id="temporary-form" action="./" method="post">
								<div class="delete-reason-select">
									<div class="edit-data">
										<aside class="delete-aside">
											<label for="deletion-reason">계정을 비활성화하시는 이유가 무엇인가요?</label>
										</aside>
									...
									<div class="reason hard-to-use">
										<p>계정을 일시적으로 비활성화하기 전에 고객 센터에서 관련 문서를 확인해보세요.</p>
										<div>
											<ul>
												<li>
								...
								<p class="delete-btn-txt">아래 버튼을 누르면 다시 로그인하여 계정을 재활성화할 때까지 사진, 댓글, 좋아요가 숨겨집니다.</p>
								<div class="delete-btn-space">
									<button class="blue-btn-small temporary-btn" disabled="disabled" type="button">계정 일시 비활성화</button>
								</div>
							</form>
						</div>
					</article>
